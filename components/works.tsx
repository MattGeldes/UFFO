...
export default function Works() {
  ...
  const works = [
    ...
    },
    {
      ...
      image: "/uffo/images/holisitca-logo.png",
      category: "Branding",
    },
    {
      ...
      image: "/uffo/images/img_work-1.jpg",
      category: "UX/UI",
    },
    {
      ...
      image: "/uffo/images/img_work-2.jpg",
      category: "Marketing",
    },
  ]
                ...
                <CardContent className="p-6">
                  ...
                  <p
                    className={`leading-relaxed text-justify ${
                      activeWork === index ? "text-primary-foreground/90" : "text-muted-foreground"
                    }`}
                  >
                    {work.description}
                  </p>
